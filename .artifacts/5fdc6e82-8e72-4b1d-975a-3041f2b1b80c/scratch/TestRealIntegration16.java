...
public class TestRealIntegration16 {
    public static void main(String[] args) {
        try {
            ...
            if (idx != -1) {
                ...
                if (itagIdx != -1) {
                    int searchFrom = itagIdx;
                    while (true) {
                        int urlIdx = json.indexOf("\"url\":\"", searchFrom);
                        if (urlIdx == -1) break;
                        ...
                        if (streamUrl.contains("googlevideo.com")) {
                            System.out.println("FOUND GOOGLEVIDEO URL AFTER ITAG 140: " + streamUrl);
                            HttpURLConnection audioConn = (HttpURLConnection) new URL(streamUrl);
