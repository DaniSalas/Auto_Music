...
public class TestRealIntegration4 {
    public static void main(String[] args) {
        try {
            ...
            if (idx != -1) {
                ...
                if (itagIdx != -1) {
                    // find the first "url":" that appears *after* itagIdx within the same format block
                    int nextBrace = json.indexOf("}", itagIdx);
                    String block = json.substring(itagIdx, nextBrace);
                    ...
                    if (urlIdx != -1) {
                        ...
                        System.out.println("STREAM URL FOUND IN BLOCK: " + streamUrl);
