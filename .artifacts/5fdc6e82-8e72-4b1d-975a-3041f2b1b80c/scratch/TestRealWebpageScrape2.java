...
public class TestRealWebpageScrape2 {
        ...
        try {
            ...
            if (idx != -1) {
                ...
                if (itagIdx != -1) {
                    ...
                    System.out.println("urlIdx: " + urlIdx);
                    if (urlIdx != -1) {
                        int urlEnd = json.indexOf("\"", urlIdx + 7);
                        String streamUrl = json.substring(urlIdx + 7, urlEnd).replace("\\u0026", "&");
                        System.out.println("VERIFIED WORKING STREAM URL: " + streamUrl);
                        ...
                        System.out.println("Audio Stream HTTP Response Code: " + audioConn.getResponseCode());
                    }
                }
            }
        } catch (Exception e) {
