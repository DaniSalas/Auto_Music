...
public class TestRealWebpageScrape3 {
    public static void main(String[] args) {
        try {
            ...
            if (idx != -1) {
                ...
                if (itagIdx != -1) {
                    System.out.println("Snippet around itag 140:");
                    System.out.println(json.substring(Math.max(0, itagIdx - 200), Math.min(json.length(), itagIdx + 400)));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
