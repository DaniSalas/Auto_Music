...
public class TestWebpageAudioUrl4 {
    public static void main(String[] args) {
        try {
            ...
            if (idx != -1) {
                ...
                if (itagIdx != -1) {
                    System.out.println("Found itag 140 at: " + itagIdx);
                    System.out.println(json.substring(itagIdx, Math.min(json.length(), itagIdx + 800)));
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
