...
public class VerifyEmbedBypass {
    public static void main(String[] args) {
        String videoId = "uzF0M-9fO_M";
        try {
            System.out.println("Testing WEB_EMBEDDED_PLAYER identity for: " + videoId);
            ...
            String payload = "{\"context\":{\"client\":{\"clientName\":\"WEB_EMBEDDED_PLAYER\",\"clientVersion\":\"1.20240821.01.00\",\"hl\":\"en\",\"gl\":\"US\"},\"thirdParty\":{\"embedUrl\":\"https://www.youtube.com/embed/" + videoId + "\"}},\"videoId\":\"" + videoId + "\"}";
            ...
            if (conn.getResponseCode() == 200) {
                ...
                if (json.contains("\"status\":\"OK\"")) {
                    ...
                    if (json.contains("\"url\":\"https://")) {
                        ...
                        System.out.println("No direct URL. Checking for cipher...");
                        if (json.contains("signatureCipher")) System.out.println("🔒 Ciphered.");
                    }
                } else {
